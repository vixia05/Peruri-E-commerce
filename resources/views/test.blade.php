        ...
        <div class="flex flex-wrap md:p-2 space-x-8">
            ...
            <div class="w-full md:w-2/5 mb-6">
                <img src="{{ asset('/images/motor.webp') }}"
                    class="block object-cover w-full h-96 mb-6 md:border-2 ">
            ...
            <div class="w-full md:w-1/2">
                ...
                <div class="grid grid-flow-row w-full px-2 space-y-6">
                    ...
                    <div class="flex flex-wrap p-1 gap-2 pb-6 border-b-2">
                        ...
                        <div class="block mt-4">
                            <button type="btn" class="bg-blue-600 bg-opacity-90 hover:bg-blue-500  rounded-sm px-6 py-3 transition">
