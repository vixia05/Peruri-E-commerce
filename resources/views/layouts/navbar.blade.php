<div class="flex flex-wrap space-y-3 md:space-x-2 md:space-y-0 py-3 px-4 md:px-6 lg:px-32 border-b-2 mb-3 sticky-top bg-slate-100">
    ...
    <div class="flex-intial w-full md:w-1/2 pl-5">
        <div class="flex mt-3">
            ...
            <button type="button" class="flex px-1 bg-blue-400 h-8 rounded-r-3xl text-white md:w-fit md:pr-4 hover:bg-blue-600">
                <svg xmlns="http://www.w3.org/2000/svg" class="min-h-full max-h-full max-w-full my-auto px-1 py-1 mx-auto md:mx-1" viewBox="0 0 20 20" fill="currentColor">
